...
# cuBLAS reductions. This matches the deterministic base-detector protocol.
...
def main():
    ...
    print(f"[Base] pos_weight = {pos_weight.item():.4f}  (n_pos={n_pos}, n_neg={n_neg})")
    ...
    tb_logger = create_logger(dataset_name, model_cfg["name"], seed, "base")
    ...
    print(f"Metrics saved to: {log_dir / 'base_training.json'}")
