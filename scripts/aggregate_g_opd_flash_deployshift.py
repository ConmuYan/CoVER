"""T7 — Aggregate G-OPD-Flash deployment-shift results.
...
Hypothesis (design v3 §6 T7):
    g_opd_flash has *smaller* Δ_deploy than off_policy KD
    (positive evidence for OPD's exposure-bias claim in GFD).
...
def main() -> None:
    ...
    # Render table
    lines: list[str] = ["# G-OPD-Flash — deployment-shift evaluation (T7)\n"]
