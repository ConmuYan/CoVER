#!/usr/bin/env bash
# T5 — G-OPD-Flash 8-cell × 5-seed × 6-mode full benchmark
#
...
#               opd_action_strict / opd_action_strict_mh  (v3.2 MJ-6 +1)
#
...
#
# Usage:
#   bash scripts/run_g_opd_flash_8cell_5seed.sh [TEACHER_RUN_NAME]
#
...
echo "[T5] Aggregate via: python scripts/aggregate_g_opd_flash.py"
