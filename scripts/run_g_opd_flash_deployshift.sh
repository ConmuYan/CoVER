#!/usr/bin/env bash
# T7 — G-OPD-Flash deployment-shift evaluation
#
# Tests OPD's exposure-bias claim: a student trained against base_v1
# should degrade *less* under G-OPD-Flash than under vanilla off-policy KD
...
#   g_opd_flash  — main method (hypothesis: lowest deploy-shift Δ)
#
...
#
# Usage:
#   bash scripts/run_g_opd_flash_deployshift.sh [TEACHER_RUN_NAME]
...
echo "[T7] Aggregate via: python scripts/aggregate_g_opd_flash_deployshift.py"
