"""Regression test for train_stage1.py --deterministic flag.
...
SCRIPT = PROJECT_ROOT / "scripts" / "train_stage1.py"
CONFIG = PROJECT_ROOT / "configs" / "yelpchi_sage.yaml"
SEED = 99
...
def test_deterministic_flag_creates_retraining_metrics():
    ...
    assert result.returncode == 0, f"train_stage1.py failed:\n{result.stderr}\n{result.stdout}"
