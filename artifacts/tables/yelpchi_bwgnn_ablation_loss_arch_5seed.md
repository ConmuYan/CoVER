...
**Champion (L7=A3)**: full 4-loss + full arch, `α_bias_init=0.0, α_max=0.3, λ_align=3e-2`  
**Seeds**: [42, 123, 456, 789, 2026]  
**Statistical test**: paired t-test (per-seed Δ vs L7), 5 seeds → df=4

## Cell legend

| Cell | Variant | Formula | HP override | Note |
|---|---|---|---|---|
| **A0** | base only | `z = b` | — | reuse fixed_v1_100ep |
...
## Paired t-test vs L7 (champion) — AUPRC

| Cell | Variant | AUPRC paired Δ vs L7 |
|---|---|---|
| A0 | base only | Δ=-0.1042 (t=-30.41, p=6.97e-06) *** |
| L0 | cls only | Δ=+0.0000 (t=+0.01, p=0.991) n.s. |
| L1 | +int | Δ=+0.0006 (t=+0.26, p=0.81) n.s. |
| L2 | +sparse | Δ=+0.0025 (t=+2.59, p=0.0609) n.s. |
| L3 | +align | Δ=-0.0004 (t=-1.14, p=0.32) n.s. |
| L4 | +int +sp | Δ=+0.0015 (t=+1.02, p=0.364) n.s. |
| L5 | +int +al | Δ=+0.0003 (t=+0.73, p=0.508) n.s. |
| L6 | +sp +al | Δ=+0.0003 (t=+0.67, p=0.541) n.s. |
| L7 | full ★ | reference |
| A1 | rel-only | Δ=+0.0014 (t=+1.23, p=0.287) n.s. |
| A2 | judge-only | Δ=-0.1042 (t=-30.42, p=6.95e-06) *** |
